...
import { Plus, BookOpen, Sparkles, ArrowUpRight } from "lucide-react";
      ...
      <div className="relative z-10 flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
        ...
        <div className="max-w-2xl">
          ...
          <p className="mt-3.5 text-sm leading-relaxed text-blue-100 sm:text-base">
            Manage your courses, create engaging curriculum content, and monitor your student enrollments from your dashboard.
          </p>
        </div>
